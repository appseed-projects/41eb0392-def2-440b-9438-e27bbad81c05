...
- Timestamp: `2022-06-07 05:35`
- Build ID: `41eb0392-def2-440b-9438-e27bbad81c05`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/41eb0392-def2-440b-9438-e27bbad81c05.git
$ cd 41eb0392-def2-440b-9438-e27bbad81c05
```
